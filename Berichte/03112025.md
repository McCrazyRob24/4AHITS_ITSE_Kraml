...
## Ergänzung für die Zusammenfassung im Hauptbericht

* **Neu bestätigte offene Ports (1–30):** 21 (FTP), 22 (SSH), 23 (Telnet), 25 (SMTP).
* Diese Ergebnisse ergänzen die bereits dokumentierten Befunde und zeigen, dass auf der Metasploitable‑VM mehrere Standarddienste aktiv sind.

---

*Ende der Übung — Netcat Port‑Scan.*
